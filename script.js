...
var foodListPrint = (foodJson) => {
  // Use map to create an array of food names
  const foodNames = foodJson.map((foods) => foods.foodname);
  // Join the array elements with line breaks to create a string
...
elementWithId.innerHTML = "<h2>1. List all the food items</h2><br><br>";
elementWithId.innerHTML += foodListPrint(foodJson);


elementWithId2 = document.getElementById("2");
elementWithId2.innerHTML="<br><h2>2. List all the food items with category vegetables</h2><br>";
elementWithId2.innerHTML += foodCategoryVegetable(foodJson);

elementWithId3 = document.getElementById("3");
elementWithId3.innerHTML="<br><h2>3. List all the food items with category fruit</h2><br>";
elementWithId3.innerHTML +=foodCategoryFruit(foodJson);

elementWithId4 = document.getElementById("4");
elementWithId4.innerHTML="<br><h2>4. List all the food items with category protien</h2><br>";
elementWithId4.innerHTML +=foodCategoryProtien(foodJson);

elementWithId5 = document.getElementById("5");
elementWithId5.innerHTML ="<br><h2>5. List all the food items with category nuts</h2><br>";
elementWithId5.innerHTML +=foodCategoryNuts(foodJson);


elementWithId6 = document.getElementById("6");
elementWithId6.innerHTML="<br><h2>6. List all the food items with category grains</h2><br>";
elementWithId6.innerHTML +=foodCategoryGrains(foodJson);

elementWithId7 = document.getElementById("7");
elementWithId7.innerHTML="<br><h2>7. List all the food items with category dairy</h1><br>";
elementWithId7.innerHTML +=foodCategoryDairy(foodJson);


elementWithId8 = document.getElementById("8");
elementWithId8.innerHTML="<br><h2>8. List all the food items with calorie above 100</h2><br>";
elementWithId8.innerHTML +=foodcalorieabove100(foodJson);

elementWithId9 = document.getElementById("9");
elementWithId9.innerHTML="<br><h2>9. List all the food items with calorie below 100</h2><br>";
elementWithId9.innerHTML +=foodcalorieBelow100(foodJson);

elementWithId10 = document.getElementById("10");
elementWithId10.innerHTML="<br><h2>10. List all the food items with highest protien content to lowest</h2><br>";
elementWithId10.innerHTML +=foodhighestprotien(foodJson);

elementWithId11 = document.getElementById("11");
elementWithId11.innerHTML="<br><h2>11. List all the food items with lowest cab content to highest</h2><br>";
